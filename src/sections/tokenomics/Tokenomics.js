...
const flowerIcon = <svg className='spinningFlower' width="150" height="150" viewBox="0 0 150 150" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div id="exchange" className="exchangeSection">
      ...
      <div className="exchangeRow">
        ...
        <StaticImage
            ...
            height={640}
            className="tokenomicsImage spinningFlower"
            placeholder="blurred"
            layout="constrained"
            alt="Shiboon"
          />
