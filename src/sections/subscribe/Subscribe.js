...
const flowerBlue = <svg className='spinningFlower22' style={{ position: 'absolute', left: 20, bottom: 0 }} width="150" height="149" viewBox="0 0 150 149" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const flowerOrange = <svg className='spinningFlower22 orange' style={{ position: 'absolute', right: 20, bottom: 90 }} width="160" height="161" viewBox="0 0 160 161" fill="none" xmlns="http://www.w3.org/2000/svg">
